...
data_name = 'ml-100k'; num_users = 943; num_items = 1682; num_total_ratings = 100000; train_ratio = 0.9
...
user_train_set,item_train_set,user_test_set,item_test_set = read_rating_100k(path, num_users, num_items,num_total_ratings, 1, 0, train_ratio)
